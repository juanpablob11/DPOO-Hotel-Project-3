...
public class reservation_panel extends JPanel implements ActionListener{
	...
	if (e.getSource() == comboBoxmonths) {
        ...
        comboBoxDays1.addActionListener(this);
	...
	if(e.getSource() == comboBoxmonths3) {
        ...
        comboBoxDays2.addActionListener(this);
	...
	public Integer getFirstYear() {
		if(selected_year == null) {selected_year = 2023;}
		return selected_year;
	}
	public Integer getSecondYear() {
		if(selected_year2 == null) {selected_year2 = 2023;}
		return selected_year2;
	}
	public Integer getFirstMonth() {
		if(selected_month == null) {selected_month = 0;}
		return selected_month;
	}
	public Integer getSecondMonth() {
		if(selected_month2 == null) {selected_month2 = 0;}
