...
public class Inventory {
	...
	public void createRoom(int id, String type, int capacity, List<Bed> listBeds, boolean view,
		...
		Room room = new Room(id, type, capacity, listBeds, view, kitchen, balcony, size_m2, air_conditioner,
				heating, tv, coffee_maker, dryer, hair_iron, ac_voltage, usb_a, usb_c, breakfast);
		Rooms.add(room);
	}
	//Getters
